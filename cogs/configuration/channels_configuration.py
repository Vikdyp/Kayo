...
class ChannelsConfiguration(commands.Cog):
    ...
    PREDEFINED_ACTIONS = [
        ...
        ("temp_vocal_category", "Catégorie vocale temporaire"),
        ("afk_channel", "Salon AFK"),
        ("valorant_info_channel", "Salon informations Valorant"),
        ("stats_channel", "Salon statistiques"),
        ("depart_thread", "Thread départs"),
        ("invite_log_channel", "Salon logs invitations"),
        ("file_counter_channel", "Salon compteur de fichiers"),
        ("rank_log_channel", "Salon logs changements de rang"),
        ("duplicate_pseudo_channel", "Salon alertes doublons pseudo"),
        ("deban_category", "Catégorie demandes de déban"),
        ("database_log_channel", "Salon logs base de données"),
        ("fer", "Salon rang fer"),
